...
4. [`ConferencePaper.pdf`]() - This conference paper provides a comprehensive overview of our project, including methodology, datasets, classifiers, output images, flowchart, and image processing techniques. It details the development process and offers insights into the system's functionalities and tools.
